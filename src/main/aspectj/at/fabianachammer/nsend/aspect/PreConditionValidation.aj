...
public aspect PreConditionValidation {
	 ...
	 */
	public pointcut setMacAddress(Byte[] b) : execution(* EthernetHeader.set*MacAddress(..)) && args(b);
	 ...
	 */
	public pointcut setEtherType(EtherType et):execution(* EthernetHeader.setEtherType(..)) && args(et);
