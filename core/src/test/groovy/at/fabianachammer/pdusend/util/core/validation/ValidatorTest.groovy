...
import at.fabianachammer.pdusend.core.util.validation.ValueNotNullException;
import at.fabianachammer.pdusend.core.util.validation.ValueNullException;
import at.fabianachammer.pdusend.core.util.validation.ValueOutOfRangeException;
